...
public:
  ...
  */
  static void CUtil::ScanPathsForAssociatedItems(const CStdString& videoPath,
  ...
  *   \param[out] itemPaths A vector containing the full paths of all found associated files.
  */
  static int CUtil::ScanArchiveForAssociatedItems( const CStdString& strArchivePath,
  ...
  *   \param[in] strMovie The full path of the video file.
